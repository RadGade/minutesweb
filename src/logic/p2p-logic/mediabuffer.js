...
export function Mediabuffer(element, progressCallback, readyCallback, disableMobileCheck, forceFullDownload) {
...
Mediabuffer.prototype.chromeBugWorkaround = function() {
	...
	this.element.currentTime = 0; // stops playback creeping forward
};
