...
import PeerCaller from './PeerCaller'
import PeerRec from './PeerRec'
...
var gunViewer = new Peer(viewer_config);
...
const gunStreamer = new PeerCaller(streamer_config)
...
//Init the recorder
const gunRecorder = new PeerRec(recorder_config);
